...
int main()
{
    ...
    do
    {
        ...
        cout << "\t\t\t\t\t#------------------------MENU-------------------------#" << endl;
        cout << "\t\t\t\t\t |                                                    | " << endl;
        cout << "\t\t\t\t\t |   1 - Finding the power of a number                | " << endl;
        cout << "\t\t\t\t\t |                                                    | " << endl;
        cout << "\t\t\t\t\t |   2 - Displays N stars in a row                    | " << endl;
        cout << "\t\t\t\t\t |                                                    | " << endl;
        cout << "\t\t\t\t\t |   3 - Calculates the sum of all numbers in range   | " << endl;
        cout << "\t\t\t\t\t |                                                    | " << endl;
        cout << "\t\t\t\t\t |   4 - finds a position from which a sequence of 10 | " << endl;
        cout << "\t\t\t\t\t |     begins numbers whose sum is minimal            | " << endl;
        cout << "\t\t\t\t\t |                                                    | " << endl;
        cout << "\t\t\t\t\t |   5 - Case 5                                       | " << endl;
        cout << "\t\t\t\t\t |                                                    | " << endl;
        cout << "\t\t\t\t\t |   6 - Case 6                                       | " << endl;
        ...
        case '5':
        {
            ...
            do
            {
                ...
                cout << "        #----------------MENU---------------#" << endl;
                cout << "         |                                  |" << endl;
                cout << "         |   1 - maximum value in           |" << endl;
                cout << "         |     one-dimensional array        |" << endl;
                cout << "         |                                  |" << endl;
                cout << "         |   2 - maximum value in           |" << endl;
                cout << "         |    two-dimensional array         |" << endl;
                cout << "         |                                  |" << endl;
                cout << "         |   3 - maximum value in           |" << endl;
        ...
        case '6':
        {
            ...
            do
            {
                ...
                cout << " #----------------MENU---------------#" << endl;
                cout << "  |                                  |" << endl;
                cout << "  |   1 - Finding the maximum        |" << endl;
                cout << "  |     values ​​of two integers       |" << endl;
                cout << "  |                                  |" << endl;
                cout << "  |   2 - Finding the maximum        |" << endl;
                cout << "  |     values ​​of three integers     |" << endl;
                cout << "  |                                  |" << endl;
                cout << " #-----------------------------------#" << endl;
                cout << "  |   0 - Exit                       |" << endl;
                cout << " #-----------------------------------#" << endl;
