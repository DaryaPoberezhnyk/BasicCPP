...
struct gp1
{
    ...
    void Input()
    {
        ...
        three = " 3. Сильна ";
        four = " 4. Урон 2хп ";
        five = " 5. Відсутнє зілля підвищення урону ";
        six = " 6. Магічна паличка 4хп (один раз за гру) ";
        line2 = "-----------------------------";
...
struct gp2
{
    ...
    void Input()
    {
        ...
        three = " 3. Надсильнй ";
        four = " 4. Урон 4хп ";
        five = " 5. Наявне зілля підвищення урону ";
        six = " 6. Магічна паличка 3хп (один раз за гру) ";
        line2 = "-----------------------------";
        vibir = " * Для підтвердження персонажа натисніть 1 : ";
    }
};
struct gp3
{
    ...
    void Input()
    {
        ...
        four = " 4. Урон 3хп ";
        five = " 5. Відсутнє зілля підвищення урону ";
        six = " 6. Магічна паличка 2хп (один раз за гру) ";
        line2 = "-----------------------------";
        vibir = " * Для підтвердження персонажа натисніть 1 : ";
    }
};
